...
export const metadata: Metadata = generateSEO({
  title: 'IPTV vs Sky Deutschland 2026 | Vergleich',
  description: 'Direkter Vergleich: StreamDACH oder Sky Deutschland? Kosten, Kanäle, Qualität und Flexibilität im Test.',
  path: '/iptv-vs-sky-deutschland',
})
  ...
  return (
    <section className="section-padding pt-32">
      <div className="container-tight px-4 text-center">
        <h1 className="heading-1 mb-6">IPTV vs Sky Deutschland</h1>
        <p className="body-large mb-8 max-w-2xl mx-auto">
          Der große Vergleich zwischen StreamDACH IPTV und Sky Deutschland. 
