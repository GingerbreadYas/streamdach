...
export const metadata: Metadata = generateSEO({
  title: 'IPTV vs Zattoo 2026 | Vergleich',
  description: 'Direkter Vergleich: StreamDACH oder Zattoo? Kosten, Kanäle, Qualität und Flexibilität im Test.',
  path: '/iptv-vs-zattoo',
})
  ...
  return (
    <section className="section-padding pt-32">
      <div className="container-tight px-4 text-center">
        <h1 className="heading-1 mb-6">IPTV vs Zattoo</h1>
        <p className="body-large mb-8 max-w-2xl mx-auto">
          Der große Vergleich zwischen StreamDACH IPTV und Zattoo. 
