...
export const metadata: Metadata = generateSEO({
  title: 'IPTV Zürich 2026 | Lokale Kanäle & Sport',
  description: 'Premium IPTV für Zürich. Alle lokalen und internationalen Sender in HD & 4K. Jetzt auf StreamDACH!',
  path: '/iptv-zurich',
})
  ...
  return (
    <section className="section-padding pt-32">
      <div className="container-tight px-4 text-center">
        <h1 className="heading-1 mb-6">IPTV Zürich</h1>
        <p className="body-large mb-8 max-w-2xl mx-auto">
          Lokales IPTV für Zürich mit allen regionalen und internationalen Sendern. 
